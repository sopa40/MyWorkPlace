    ...
    *************************************************************************/
    ...
    public static class test{
  	  public static void test(){
  	      ...
  	      double x=1;
  	      double y=2;
  	      StdDraw.arc(4,4,8,0,-90);
  	      StdDraw.arc(-4,-4,8,0,90);
  	      StdDraw.line(-4, 4, 4, -4);
  	      StdDraw.line(4, 4, -4, -4);
  	      double b;
  	      double d;
  	      double e;
  	      ...
  	      for(double f=-4.0;f<=4.0;f+=0.1){
  	    	  e=8-(Math.sqrt(64-Math.pow(f-4,2))+4);
  	    	  StdDraw.line(-4, f,e , f);
  	      }
  	      StdDraw.setPenColor(BLUE);
  	      for(double c=-4.0;c<=4.0;c+=0.1){
  	    	  d=(Math.sqrt(64-Math.pow(c+4,2))-4);
  	    	  StdDraw.line(c, 4, c, d);
  	      }
  	      for(double h=-4.0;h<=4.0;h+=0.1){
    ...
    public static class Mickey{
		...
		public static final double smallestRadius = 0.05;
